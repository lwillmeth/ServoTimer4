/*
  ServoTimer4.h - Interrupt driven Servo library for Arduino using Timer2- Version 0.1
...
/* 
  ...
  The methods are:
   ...
   ServoTimer4 - Class for manipulating servo motors connected to Arduino pins.
...
#ifndef ServoTimer4_h
#define ServoTimer4_h
...
// the following ServoArrayT4 class is not implemented in the first version of this library
class ServoArrayT4
{
  public:
	// constructor:
